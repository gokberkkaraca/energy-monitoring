...
public class DatabaseHandler {
    ...
    private static final String DATABASE_POLAR_HEART_RATES_PATH = "Polar:heartRates";
    ...
    public static void getPolarHeartRateData(User user, ValueEventListener valueEventListener) {
        databaseReference.child(DATABASE_USERS_PATH).child(user.getUserId()).child(DATABASE_POLAR_HEART_RATES_PATH).addValueEventListener(valueEventListener);
    }

    public static void addPolarHeartRateData(final User user, final ArrayList<HeartRateData> heartRateDataList) {
        databaseReference.child(DATABASE_USERS_PATH).child(user.getUserId()).child(DATABASE_POLAR_HEART_RATES_PATH).setValue(heartRateDataList);
    }
